...
<div>
    <div class="row">
        <div class="col-sm-6">
            <section class="panel">
                <div class="panel-body" ng-controller="heroQueryController">

                    <div class="panel-body" ng-hide="heroSearchBox==1">
                        <form class="form-horizontal " ng-submit="heroSearchForm()" id="heroSearchForm"
                              name="heroSearchForms">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-xs-11">
                                    <select name="gameList" aria-controls="editable-sample"
                                            ...
                                            ng-model="heroSearchData.gameId"  ng-change="gameIdChange(heroSearchData.gameId)"  required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-xs-11">
                                    <select aria-controls="editable-sample" class="form-control"
                                            ng-model="heroSearchData.serverId"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-xs-11">
                                    <input type="text" class="form-control" maxlength="50"
                                           ng-model="heroSearchData.roleId">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-xs-11">
                                    <input type="text" class="form-control" maxlength="50"
                                           ng-model="heroSearchData.roleName">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-xs-11">
                                    <input type="text" class="form-control" maxlength="50"
                                           ng-model="heroSearchData.userId">
                                </div>
                            </div>
                    ...
                    <div class="panel-body" ng-hide="heroSearchBox==0">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body" style="width: 100%;">
                                ...
                                <div ng-hide="heroItems.length!=0"  translate="load.notFindPlayer">
                                </div>
                            </div>
