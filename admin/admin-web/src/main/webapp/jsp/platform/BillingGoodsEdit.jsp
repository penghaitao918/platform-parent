                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group labelSpace">
                                ...
                                <input type="number" class="form-control disaccount" name="disaccount"
                                       ng-model="goodsData.disaccount" maxlength="50" min="0" max="100000000000"
                                       required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group labelSpace">
                                ...
                                <select name="validStatus" aria-controls="editable-sample"
                                    ...
                                    <option value="3" translate="load.validStatusRemoved"></option>
                                </select>
                            </div>
                            <div class="col-md-3 form-group labelSpace">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr ng-repeat="gameToyType in gameTypeToys" ng-click="itemItemChoice(gameToyType)">
                            ...
                            <td>{{gameToyType.itemExtend}}</td>
                        </tr>
                        </tbody>
                    </table>
                    <div class="pager">
                        <pager page-count="pageCountItem" current-page="currentPageItem"
                               on-page-change="onPageChangeItem()" first-text="load.HomePage"
                               next-text="load.NextPage" prev-text="load.PreviousPage" last-text="load.EndPage"
                               show-goto="true" goto-text="load.GoToPage"></pager>
                    </div>
                </div>
