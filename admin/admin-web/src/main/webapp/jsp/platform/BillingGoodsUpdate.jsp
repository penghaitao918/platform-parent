...
<section class="wrapper">
    <div class="panel-body" ng-controller="billingGoodsUpdateController">
        <form role="form" ng-submit="billingGoodsUpdateForm()" name="billingGoodsUpdateForms">
    <div class="row">
        <div class="col-sm-6">
            <section class="panel">
                ...
                <div class="panel-body" >
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <span ng-show="billingGoodsUpdateForms.goodsName.$error.alphanum" style="color: red;"><span translate="load.lettersAndInteger"></span></span>
                    </div>

                    <div class="col-md-3 form-group">
                        <label><span translate="load.goodsGoodsDesc"></span>:</label>
                        <input  type="text"   class="form-control goodsDesc" ng-model="goodsData.goodsDesc">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 form-group">
                            ...
                            <span ng-show="billingGoodsUpdateForms.goodsAmount.$error.integer" style="color: red;"><span translate="load.numLength"></span></span>
                            <span ng-show="billingGoodsUpdateForms.goodsAmount.$error.min || billingGoodsUpdateForms.goodsAmount.$error.max" style="color: red;">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <span ng-show="billingGoodsUpdateForms.goodsCount.$error.integer" style="color: red;"><span translate="load.numLength"></span></span>
                            <span ng-show="billingGoodsUpdateForms.goodsCount.$error.min || billingGoodsUpdateForms.goodsCount.$error.max" style="color: red;">
                                    <span translate="load.numBetween"></span>
                            </span>
                        </div>
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <span ng-show="billingGoodsUpdateForms.unitPrice.$error.integer" style="color: red;"><span translate="load.numLength"></span></span>
                            <span ng-show="billingGoodsUpdateForms.unitPrice.$error.min || billingGoodsUpdateForms.unitPrice.$error.max" style="color: red;">
                                    <span translate="load.numBetween"></span>
                            </span>
                        </div>
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <span ng-show="billingGoodsUpdateForms.goodsCode.$error.alphanum" style="color: red;"><span translate="load.lettersAndInteger"></span></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 form-group">
                            ...
                            <select name="relatedGoodsId" aria-controls="editable-sample" class="form-control relatedGoodsId" ng-model="goodsData.relatedGoodsId" required>
                                <option value="">请选择</option>
                                <option value="re.gvg.01">关联商品一</option>
                                <option value="re.gvg.02">关联商品二</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <span ng-show="billingGoodsUpdateForms.disaccount.$error.alphanum" style="color: red;"><span translate="load.lettersAndInteger"></span></span>
                        </div>
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <select name="validStatus" aria-controls="editable-sample" class="form-control validStatus" ng-model="validStatus" required>
                                ...
                                <option value="1" translate="load.validStatusUnact"></option>
                                <option value="2" translate="load.validStatusActing"></option>
                                <option value="3" translate="load.validStatusLocked"></option>
                                <option value="4" translate="load.validStatusActed"></option>
                                <option value="5" translate="load.validStatusReject"></option>
                                <option value="6" translate="load.validStatusError"></option>
                            </select>
                        </div>
                ...
                <div class="panel-body" >
                    ...
                    <div class="modal-footer">
                        <div style="float: right;margin-right: 20px;">
                            ...
                            <button type="submit" class="btn btn-primary addSubmit" ng-disabled="billingGoodsUpdateForms.$invalid" > <span translate="load.Ok"></span></button>
                        </div>
                        <p ng-hide="!billingGoodsUpdateForms.$invalid" style="color: red;float: right;margin-top: 15px;"><span translate="load.remindValidate"></span></p>
                    </div>
                    </div>
            </section>
        </div>
                    ...
                    <div class="modal-body" >
                        ...
                        <div class="row">
                            <form class="form-horizontal bucket-form"  ng-submit="firstAwardForm()" >
                                ...
                                <div class="pager">
                                    <pager page-count="pageFirstAwardCount" current-page="currentFirstAwardPage" on-page-change="onFirstAwardPageChange()" first-text="load.HomePage" next-text="load.NextPage" prev-text="load.PreviousPage" last-text="load.EndPage" show-goto="true" goto-text="load.GoToPage"></pager>
                                </div>
                                <div class="modal-footer" style="width:750px;">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
