...
adminApp.config(function ($routeProvider) {
    $routeProvider.when('/billingGoodsUpdate/view/:id', {
        templateUrl: ctx + '/platform/billingGoods/billingGoodsUpdateInit',
        controller: 'billingGoodsUpdateController'
    });
});
 ...
 */
adminApp.controller('billingGoodsUpdateController', function($scope,billingGoodsFnService,gameAreaFnService,$location,$routeParams) {
    ...
    $scope.onPageChange = function() {
         ...
         */
        gameAreaFnService.gameAreaFindByName($scope.billingGoodsSearch,$scope.currentPage,10).success(function (response) {
    ...
    /*
     监听商品form
     */
    $scope.billingGoodsUpdateForm=function(){
