...
adminApp.config(function ($routeProvider) {
    $routeProvider.when('/awardPackage/view', {
        templateUrl: ctx + '/platform/billingGoods/awardPackageInit',
        controller: 'awardPackageController'
    });
});
 ...
 */
adminApp.controller('awardPackageController', function($scope,billingGoodsFnService,gameAreaFnService,$location) {
