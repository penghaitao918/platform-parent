...
@Generated("java_bean")
public final class GmTableValue implements Externalizable, Message<GmTableValue>, Schema<GmTableValue>
{

    public static Schema<GmTableValue> getSchema()
    {
        return DEFAULT_INSTANCE;
    }

    public static GmTableValue getDefaultInstance()
    {
        return DEFAULT_INSTANCE;
    }

    static final GmTableValue DEFAULT_INSTANCE = new GmTableValue();
    ...
    public boolean equals(Object obj) {
        ...
        final GmTableValue that = (GmTableValue) obj;
        return
                Objects.equals(this.mColumnName, that.mColumnName) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mColumnName, mValueUint64, mValueInt64, mValueUint32, mValueInt32, mValueBool, mValueString);
    }
    ...
    public Schema<GmTableValue> cachedSchema()
    {
        return DEFAULT_INSTANCE;
    }
    ...
    public GmTableValue newMessage()
    {
        return new GmTableValue();
    }

    public Class<GmTableValue> typeClass()
    {
        return GmTableValue.class;
    }

    public String messageName()
    {
        return GmTableValue.class.getSimpleName();
    }

    public String messageFullName()
    {
        return GmTableValue.class.getName();
    }

    public boolean isInitialized(GmTableValue message)
    {
        return true;
    }

    public void mergeFrom(Input input, GmTableValue message) throws IOException
    {
        for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
        {
            switch(number)
            {
                case 0:
                    return;
                case 1:
                    message.mColumnName = input.readString();
                    break;
                case 2:
    ...
    public void writeTo(Output output, GmTableValue message) throws IOException
    {
        if(message.mColumnName != null)
            output.writeString(1, message.mColumnName, false);
